...
function funConvertWebsite( $options )
{
  ...
  while ( $url = $stmt->fetch( PDO::FETCH_ASSOC ) ) {
    ...
    $destination = str_replace( DIRECTORY_SEPARATOR . DIRECTORY_SEPARATOR, DIRECTORY_SEPARATOR, $output . DIRECTORY_SEPARATOR . $url['hostname'] . DIRECTORY_SEPARATOR . $pathinfo['dirname'] . DIRECTORY_SEPARATOR . $filename ); // fixed
